  ...
  return (
    <Page title="Home">
      ...
      <div className="p-4 md:p-8 container relative mx-auto md:flex justify-around items-start">
        <div className="flex flex-col justify-end absolute md:static top-0 bottom-0 right-0 opacity-50 md:opacity-100 self-center w-1/2 md:w-5/12 lg:w-4/12 headline-img px-4">
          <img alt="" src="/images/peep.svg" />
        </div>
        <div className="md:bg-blue-200 md:p-12 lg:p-16 xl:p-20 my-32 sm:mx-8 headline-container">
